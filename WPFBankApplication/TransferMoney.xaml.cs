...
namespace WPFBankApplication
{
    ...
    public partial class TransferMoney
    {
        ...
        private void SendMobileNotificationToReciver()
        {
            ...
            var sentMessage =
                string.Format(
                    "Rs.{0} has been transfered to your Alexa bank account (Acc no - {1}) from other account (Acc no -  {2}). Your current balance is {3} .",
                    TextBoxMoneyAmount.Text, TextBoxAccountNumber.Text, TextBoxAccountNumber.Text,
                    RemainingReceiverBalance);
        ...
        public void SendMobileNotification()
        {
            ...
            var sentMessage =
                string.Format(
                    "Rs.{0} has been transfered from your Alexa bank account (Acc no - {1}) to other account (Acc no -  {2})",
                    TextBoxMoneyAmount.Text, _accountNum, TextBoxAccountNumber.Text);
